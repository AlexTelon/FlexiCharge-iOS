...
struct MapView: View {
    ...
    var body: some View {
        Map(coordinateRegion: $region, annotationItems: chargers) { charger in
            MapAnnotation(
...
struct MapView_Previews: PreviewProvider {
    static var previews: some View {
        MapView(chargers: .constant([Charger(chargerID: 999999, location: [57.778568, 14.163727], chargePointID: 9, serialNumber: "%&(/K€OLC:VP", status: "Available")]))
    }
}
